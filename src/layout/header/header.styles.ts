...
export const StyledHeader = styled.header(
  ({ showHeaderBG, showSearchButton, showDropdown }: StyledHeaderProps) => [
    ...
    css`
      ...
      > button {
        ${tw`hidden sm:flex items-center p-1 space-x-6 border-2 rounded-2xl cursor-pointer pointer-events-none opacity-0 transform scale-50 translate-y-6 origin-center transition duration-300 focus:outline-none`};
